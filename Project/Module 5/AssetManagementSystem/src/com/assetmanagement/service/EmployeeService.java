...
public class EmployeeService {
    ...
    public EmployeeService(EmployeeRepository employeeRepo) {
        this.employeeImpl = new EmployeeImpl(employeeRepo);
    }
    ...
    public static void addEmployee() {
        ...
        employeeImpl.addEmployee(new Employee(id, name, email, phone, designation));
    ...
    public static void removeEmployee() {
        ...
        employeeImpl.removeEmployee(id);
    ...
    public static void updateEmployee() {
        ...
        employeeImpl.updateEmployee(new Employee(id, name, email, phone, designation));
    ...
    public static void getEmployee() {
        ...
        Employee employee = employeeImpl.getEmployee(id);
        if (employee != null) {
