...
public class HardwareAssetService {
    ...
    private static HardwareAssetIntf hardwareAssetIntf;
    private static Scanner scanner = new Scanner(System.in);

    public HardwareAssetService(HardwareAssetRepository hardwareAssetRepo) {
        this.hardwareAssetIntf = new HardwareAssetImpl(hardwareAssetRepo);
    }
    ...
    public static void addHardwareAsset() {
        ...
        hardwareAssetIntf.addHardwareAsset(new HardwareAsset(id, name, type, date, price, warranty, status));
    ...
    public static void removeHardwareAsset() {
        ...
        hardwareAssetIntf.removeHardwareAsset(id);
    ...
    public static void updateHardwareAsset() {
        ...
        hardwareAssetIntf.updateHardwareAsset(new HardwareAsset(id, name, type, date, price, warranty, status));
    ...
    public static void getHardwareAsset() {
        ...
        HardwareAsset asset = hardwareAssetIntf.getHardwareAsset(id);
        if (asset != null) {
    ...
    public static void listAllHardwareAssets() {
        List<HardwareAsset> assets = hardwareAssetIntf.getAllHardwareAssets();
        // Print table header
        System.out.printf("%-10s %-20s %-15s %-15s %-15s %-20s %-10s%n", 
                          "ID", "Name", "Type", "Purchase Date", "Price", "Warranty (months)", "Status");
        System.out.println("--------------------------------------------------------------------------------------------------");
